                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ url('galeri/update/'.$galeris->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                {{-- Input type karena untuk proses update kita butuh old_image atau data yang lama --}}
                                <input type="hidden" name="old_image" value="{{$galeris->image}}" >

                               
                                {{-- Image --}}
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Edit Galeri</label>
                                ...
                                <div class="form-group">
                                    <img src="{{asset($galeris->image)}}" style="width: 400px; height: 300px">
                                </div>

                                <button type="submit" class="btn bg-primary text-white">Update Galeri</button>
                            </form>
                        </div>
                    </div>
                </div>
