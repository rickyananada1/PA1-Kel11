                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> {{ $about->long_des}} </td>
                                      {{-- Menggunakan Model --}}
                                      <td>  <img src="{{ asset($about->image) }}" style="height: 40px; width: 70px">
                                      </td>
                                  </td>
                                  ...
                                  <p>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('about/delete/'.$about->id) }}" onclick="return confirm('Are You Sure U Want To Delete The Slider')" 
