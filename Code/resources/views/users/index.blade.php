    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row icon-boxes">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch  mb-lg-0" data-aos="zoom-in" data-aos-delay="300">
              <div class="icon-box">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch  mb-lg-0" data-aos="zoom-in" data-aos-delay="400">
              <div class="icon-box">
                <div class="icon"><i class="ri-command-line"></i></div>
                <h4 class="title"><a href="">Magni Dolores</a></h4>
                <p class="description">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui official</p>
              </div>
            </div>
    
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch  mb-lg-0" data-aos="zoom-in" data-aos-delay="500">
              <div class="icon-box">
